                ...
                <div class="card card-info">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="" enctype="multipart/form-data"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <input type="text" name="de_ip" class="form-control" id="de_ip"
                                                placeholder="Nhập địa chỉ IP">
                                            @if ($errors->has('de_ip'))
                                                <div class="error">{{ $errors->first('de_ip') }}</div>
                                            @endif
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="de_username" class="form-control" id="de_username"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="de_password" class="form-control" id="de_password"
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="de_servie" class="col-sm-6 col-form-label">Dịch vụ sử dụng</label>
                                    <div class="col-md-10">
